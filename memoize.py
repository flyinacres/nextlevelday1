...
# This works, but assumes that the arguments are always in the same order.
# This may be true as python might assign them to the proper vars.  Not sure it is though.
def memoize(func):
    dict = {}
    def wrapper(*args):
        #print("args are: ", args)
